...
//
//        Film film1 = new Film("name1", "description1", "2001-01-01", 111, 5,
//                new Mpa(1), new HashSet<>());
//        Film film2 = new Film("name2", "description2", "2002-02-02", 222, 5,
//                new Mpa(1), new HashSet<>());
//        Film film3 = new Film("name3", "description3", "2003-03-03", 333, 5,
//                new Mpa(1), new HashSet<>());
//
...
//
//    @Test
//    void checkingForCorrectnessOfAddingLikes() throws SQLException, IOException {
...
//
//    @Test
//    void checkingForCorrectnessOfDeletingLikes() throws SQLException, IOException {
//        filmService.addLike(1, 1);
//        filmService.addLike(2, 1);
//        filmService.addLike(2, 2);
//        filmService.addLike(3, 1);
...
//
//    @Test
//    void theCorrectListOfPopularMoviesShouldBeReturned() throws SQLException, IOException {
//        filmService.addLike(1, 1);
//        filmService.addLike(2, 1);
//        filmService.addLike(2, 2);
//        filmService.addLike(3, 1);
