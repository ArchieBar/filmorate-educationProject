...
//
//    @Test
//    public void methodForGettingAllMoviesShouldReturnCorrectNumberOfMovies() throws ValidationException, SQLException, IOException {
//        Film film1 = new Film("name", "description", "2000-01-01", 100, 1,
//                new Mpa(1));
//        Film film2 = new Film("name", "description", "2000-01-01", 100, 1,
//                new Mpa(1));
...
//
//    @Test
//    public void createdMovieMustMatchTheMovieInMemory() throws ValidationException, SQLException, IOException {
//        Film film1 = new Film("name", "description", "2000-01-01", 100, 1,
//                new Mpa(1));
//        filmController.createFilm(film1);
//
...
//
//    @Test
//    public void afterUpdatingTheMovieOnlyTheUpdatedMovieShouldBeStoredInMemory() throws ValidationException, SQLException, IOException {
//        Film film1 = new Film("name", "description", "2000-01-01", 100, 1,
//                new Mpa(1));
//        filmController.createFilm(film1);
//
...
//
//        Film filmNow = new Film("nameNew", "description", "2000-01-01", 100, 1,
//                new Mpa(1));
...
//        Film film = new Film(" ", "description", "2000-01-01", 100, 1,
//                new Mpa(1));
//
...
//
//    @Test
//    public void ifYouTryToCreateAMovieWithIncorrectDescriptionAnExceptionShouldBeThrown() throws ValidationException, SQLException, IOException {
...
//
//    @Test
//    public void ifYouTryToCreateAMovieWithIncorrectDataReleaseAnExceptionShouldBeThrown() throws ValidationException, SQLException, IOException {
//        Film beforeEarliestReleaseDataFilm = new Film("beforeEarliestReleaseDataFilm",
//                "Новое_Описание_1", "1850-01-01", 100, 1, new Mpa(1), new HashSet<>());
//        Film earliestReleaseDataFilm = new Film("earliestReleaseDataFilm",
//                "Новое_Описание_1", LocalDate.of(1895, 12, 28).toString(), 100, 1,
//                new Mpa(1));
//        Film afterEarliestReleaseDataFilm = new Film("afterEarliestReleaseDataFilm",
//                "Новое_Описание_1", "2000-01-01", 100, 1, new Mpa(1), new HashSet<>());
//
...
//
//    @Test
//    public void ifYouTryToCreateAMovieWithNegativeDurationAnExceptionShouldBeThrown() throws ValidationException, SQLException, IOException {
//        Film filmNegativeDuration = new Film("filmNegativeDuration",
//                "Описание_1", "2000-01-01", -100, 1, new Mpa(1), new HashSet<>());
//        Film filmZeroDuration = new Film("filmZeroDuration",
//                "Описание_1", "2000-01-01", 0, 1, new Mpa(1), new HashSet<>());
